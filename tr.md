...
- Bir iş problemini analiz aşamasından çalışan ürüne kadar taşıyorum.

## İş Deneyimi

### Kurucu ve Yazılım Geliştirici — Lydor
...
**Nisan 2025 – Eylül 2025 · Ofis**

- Müşterilere ait finansal PDF belgelerindeki verilerin otomatik olarak okunmasını ve düzenli biçimde veritabanına kaydedilmesini sağladım.
- İşlenen verilerden, şirketin belirlediği kurallar doğrultusunda müşteriye özel kredi tavsiyesi üreten bir iş akışı geliştirdim.
- Şirketin temel iş süreçlerinde kullanılan CRM sisteminin teknik altyapısını oluşturdum.

## Öne Çıkan Projeler

### Kişiselleştirilmiş Ürün Üretim Otomasyonu
...
- **Web teknolojileri:** React, Node.js, REST API
- **Veri ve backend:** SQL, Supabase, doküman işleme
- **Altyapı:** Cloudflare, zamanlanmış iş akışları, üçüncü taraf API entegrasyonları
- **Odak alanları:** Otomasyon, full-stack geliştirme, CRM araçları ve iş süreçlerinin dijitalleştirilmesi

## Eğitim

- **42 Kocaeli — Yazılım Geliştirme**  
  Ekim 2024 – Kasım 2026 (Beklenen)
